...
<section class="error-section">
  <div class="error-wrapper">
    ...
    <p class="error-body">
      You are not authorized to access this page. It may have been moved, deleted, or you might not have the necessary permissions to view it.
    </p>
    ...
    <div class="corner-mark">access denied</div>
  </div>
</section>
